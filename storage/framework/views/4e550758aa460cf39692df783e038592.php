            ...
            <div class="ju-wrap">
                    ...
                    <form wire:submit.prevent="filterJurnal">
                        <div class="ju-filter-row">
                            ...
                            <div class="ju-filter-field">
                                ...
                                <div class="ju-month-input">
                                    <input type="month" wire:model="periode_akhir" min="<?php echo e($periode_awal); ?>">
                                    <svg class="ju-month-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10m-13 9h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2Z" />
                                    </svg>
                                </div>
                ...
                <div class="ju-header">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periode_awal && $periode_akhir): ?>
                        <p>Periode <?php echo e(\Carbon\Carbon::parse($periode_awal)->translatedFormat('F Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($periode_akhir)->translatedFormat('F Y')); ?></p>
                ...
                <table class="jurnal-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $jurnals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurnal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    <td class="text-center-cell">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->first): ?>
                                            <?php echo e(\Carbon\Carbon::parse($jurnal->tanggal)->format('d/m/Y')); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>

                                    <td class="text-center-cell"><?php echo e($detail->coa?->kode_akun ?? $detail->kode_akun); ?></td>
                                    ...
                                    <td class="text-left-cell">
                                        ...
                                        <?php else: ?>
                                            <span style="margin-left:25px;"><?php echo e($detail->coa->nama_akun ?? '-'); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>

                                    <td class="text-center-cell">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->first): ?>
                                            <?php echo e($nomorBukti); ?>
                    ...
                    <tfoot>
                        <tr class="row-total">
                            ...
                            <td class="text-right-cell total-cell">Rp<?php echo e(number_format($totalDebit, 0, ',', '.')); ?></td>
                            <td class="text-right-cell total-cell">Rp<?php echo e(number_format($totalKredit, 0, ',', '.')); ?></td>
                        </tr>
                    </tfoot>
                </table>
...
<?php /**PATH C:\xampp\htdocs\TA2025\resources\views/filament/admin/resources/jurnal-umums/widgets/jurnal-umum-overview.blade.php ENDPATH**/ ?>