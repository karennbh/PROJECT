<script>
    (() => {
        ...
        if (isTabReauth || window.location.search.includes('next=')) {
            window.history.replaceState({}, document.title, '<?php echo e(route('login')); ?>');
        }
...
<?php /**PATH C:\xampp\htdocs\TA2025\resources\views/partials/tab-auth-login-script.blade.php ENDPATH**/ ?>